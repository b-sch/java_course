...
public class RunMethods {
    ...
    public static void main(String[] args) {
        ...
        List<StoreEmployee> storeEmployees = new ArrayList<>(List.of(
                ...
                new StoreEmployee(10515, "Joe", 2015, "Walmart"),
                new StoreEmployee(10105, "Tom", 2022, "Macys"),
                new StoreEmployee(10215, "Marty", 2013, "Walmart"),
                new StoreEmployee(10322, "Bud", 2023, "Target")
        ));
