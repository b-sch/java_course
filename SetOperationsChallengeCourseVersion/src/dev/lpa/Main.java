...
public class Main {
    public static void main(String[] args) {
        ...
        sortAndPrint("Assgined Tasks", assignedTasks);
        ...
        sortAndPrint("UnassignedTasks Tasks", unassignedTasks, sortByPriority);
    ...
    private static void sortAndPrint(String header, Collection<Task> collection, Comparator<Task> sorter) {
        ...
        System.out.printf("%s%n%s%n%s%n", lineSeparator, header, lineSeparator);
